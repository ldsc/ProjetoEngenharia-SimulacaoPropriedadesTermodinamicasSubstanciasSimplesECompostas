#ifndef CPengRobinson_h
#define CPengRobinson_h
...
class CPengRobinson: public CEquacaoEstado{

public:

//Construtor
CPengRobinson(): CEquacaoEstado() {};
CPengRobinson(CPengRobinson& obj);
CPengRobinson(std::vector<CSubstancia> _vsubstancia, std::vector<double> _tR, std::vector<double> _a, std::vector<double> _b, std::vector<double> _kappa, std::vector<double> _alpha, double _aT, double _aMaiusculo, double _bMaiusculo, double _aij, double _interecao, double _aMix, double _bMix, std::vector<double> _fugacidade);
~CPengRobinson()=default;
